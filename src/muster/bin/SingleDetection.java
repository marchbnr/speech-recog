...
public class SingleDetection implements DetectionViewIfc {
	...
	public void init(ReferenceDB refDB) throws Exception {
		detector = new SimpleDetection(refDB);
	...
	public static void main(String[] args) throws Exception {
		...
		SingleDetection det = new SingleDetection();
